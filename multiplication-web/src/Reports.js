      ...
      <div className="reports-content">
        ...
        <div className="reports-stats-row card">
          <div className="reports-stat">
            ...
            <div className="reports-stat-value">127</div>
          </div>
          <div className="reports-stat">
            ...
            <div className="reports-stat-value" style={{ color: "#3ecf8e" }}>78.1%</div>
            <div className="reports-stat-desc" style={{ color: "#3ecf8e" }}>+2.1% improvement</div>
          </div>
          <div className="reports-stat">
            ...
            <div className="reports-stat-value" style={{ color: "#ff6b6b" }}>12</div>
            <div className="reports-stat-desc" style={{ color: "#ff6b6b" }}>&lt; below 60% score</div>
          </div>
          <div className="reports-stat">
            ...
            <div className="reports-stat-value" style={{ color: "#3ecf8e" }}>24</div>
            <div className="reports-stat-desc" style={{ color: "#3ecf8e" }}>&gt; above 85% score</div>
          </div>
        </div>
        <div className="reports-main-row">
            ...
            <div className="reports-student-table">
              ...
              <div className="reports-table-row">
                <div className="reports-student-info">
                  ...
                  <div>
                    <div className="reports-student-name">Justine Nabunturan</div>
                    <div className="reports-student-meta">ID: 123456789</div>
                  </div>
                </div>
                <span className="reports-score reports-score-green">96%</span>
              </div>
              <div className="reports-table-row">
                <div className="reports-student-info">
                  <img src={people} alt="" className="reports-student-img" />
                ...
                <span className="reports-score reports-score-yellow">78%</span>
              </div>
              <div className="reports-table-row">
                <div className="reports-student-info">
                  <img src={people} alt="" className="reports-student-img" />
                ...
                <span className="reports-score reports-score-blue">85%</span>
              </div>
            </div>
            <div className="reports-pagination">
              <span className="reports-page active">1</span>
              <span className="reports-page">2</span>
              <span className="reports-page">3</span>
              <span className="reports-page">4</span>
            </div>
          </div>
          <div className="reports-side-col">
            <div className="reports-side-card card">
              ...
              <div className="reports-performer-row">
                <div>
                  <div className="reports-performer-name">Prince Umpad</div>
                  <div className="reports-performer-meta">Level 3 • 47/50 questions answered correctly</div>
                </div>
                <span className="reports-performer-score reports-score-green">94%</span>
              </div>
              <div className="reports-performer-row">
                <div>
                  <div className="reports-performer-name">Prince Umpad</div>
                ...
                <span className="reports-performer-score reports-score-blue">92%</span>
              </div>
              <div className="reports-performer-row">
                <div>
                  <div className="reports-performer-name">Prince Umpad</div>
                ...
                <span className="reports-performer-score reports-score-yellow">89%</span>
              </div>
            </div>
            <div className="reports-side-card card">
              ...
              <div className="reports-support-row">
                <div className="reports-support-info">
                  <img src={people} alt="" className="reports-support-img" />
                  <div>
                    <div className="reports-support-name">Prince Umpad</div>
                    <div className="reports-support-meta">42% • Struggling with Level 1</div>
                  </div>
                </div>
              </div>
              <div className="reports-support-row">
                <div className="reports-support-info">
                  ...
                  <div>
                    <div className="reports-support-name">Prince Umpad</div>
                    <div className="reports-support-meta">29% • Needs Level 1 Review</div>
                  </div>
                </div>
              </div>
              <div className="reports-support-row">
                <div className="reports-support-info">
                  ...
                  <div>
                    <div className="reports-support-name">Prince Umpad</div>
                    <div className="reports-support-meta">45% • Missing fundamentals</div>
                  </div>
                </div>
              </div>
            </div>
